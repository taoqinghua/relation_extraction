...
class EEDataProcessor(object):
    def __init__(self, root, is_lower=True, no_entity_label='O'):
        ...
        self.train_path = os.path.join(self.task_data_dir, 'tqh_train.json')
        self.dev_path = os.path.join(self.task_data_dir, 'tqh_dev.json')
        self.test_path = os.path.join(self.task_data_dir, 'tqh_test.json')

        #self.label_map_cache_path = os.path.join(self.task_data_dir, 'CMeEE_label_map.dict')
        self.label_map_cache_path = os.path.join(self.task_data_dir, 'tqh_label_map.dict')
        self.label2id = None
        self.id2label = None
